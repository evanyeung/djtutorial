...
def create_poll(question, days):
	"""
	Creates a poll with the give 'question' published the given number of
	'days' offset to now (negative for polls published in the past, positive for
	polls that have yet to be published).
	"""
